...
params = {
	...
	'seasoned x mean': 110.0,
	'seasoned y mean': 110.0,
	'seasoned x std dev': 20.0,
	'seasoned y std dev': 20.0,
...
def main():
	...
	seasoned = LinePopulation( params['seasoned x mean'], params['seasoned y mean'],
	...
	plotter = Plotter('centripetal', params['plot period'], params['stop time'], params)
